...
from transformers.models.gpt2.modeling_gpt2 import PARALLELIZE_DOCSTRING, GPT2_INPUTS_DOCSTRING
...
from transformers.models.gpt2.modeling_gpt2 import DEPARALLELIZE_DOCSTRING
...
class GPT2Prefix(GPT2PreTrainedModel):
    def __init__(self, config):
        ...
        self.config = config
        self.transformer = GPT2LMHeadModel.from_pretrained(config.plm)
...
class GPT2PrefixModel(GPT2PreTrainedModel):
    ...
    def save(self, save_path):
        torch.save(self.prefix_encoder.state_dict(), save_path + 'prefix_encoder.pt')

    def load(self, save_path):
        state_dict = torch.load(save_path + 'prefix_encoder.pt', map_location=self.device)
